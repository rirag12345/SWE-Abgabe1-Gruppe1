...
import { type GraphQLQuery } from '../universitaet/universitaet-mutation.resolver.test.js';
import { type GraphQLResponseBody } from '../universitaet/universitaet-query.resolver.test.js';
