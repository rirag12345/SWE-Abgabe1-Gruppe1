...
= Abgabe 1 mit Nest, REST, GraphQL, TypeORM, JWT und Jest

Jürgen Zimmermann <Juergen.Zimmermann@h-ka.de>

Philip Neuffer <neph1015@h-ka.de> https://www.h-ka.de

Felix Jäger <jafe1011@h-ka.de> https://www.h-ka.de

Yannis Mechnich <meya1019@h-ka.de> https://www.h-ka.de
